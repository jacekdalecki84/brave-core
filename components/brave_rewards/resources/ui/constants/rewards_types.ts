...
export const enum types {
  ...
  CLEAR_STATEMENTS = '@@rewards/CLEAR_STATEMENTS',
  GET_AUTO_CONTRIBUTE_STATEMENTS = '@@rewards/GET_AUTO_CONTRIBUTE_STATEMENTS',
  ON_GET_AUTO_CONTRIBUTE_STATEMENTS = '@@rewards/ON_GET_AUTO_CONTRIBUTE_STATEMENTS',
  ADD_ONE_TIME_TIP_CONTRIBUTION = '@@rewards/ADD_ONE_TIME_TIP_CONTRIBUTION',
  ADD_RECURRING_TIP_CONTRIBUTION = '@@rewards/ADD_RECURRING_TIP_CONTRIBUTION',
  ADD_AUTO_CONTRIBUTION = '@@rewards/ADD_AUTO_CONTRIBUTION',
  ADD_TRANSACTION = '@@rewards/ADD_TRANSACTION'
}
