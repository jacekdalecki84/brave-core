...
void LedgerImpl::OnWalletInitializedInternal(int32_t result,
...
void LedgerImpl::OnLedgerStateLoaded(int32_t result,
...
void LedgerImpl::OnPublisherStateLoaded(int32_t result,
                                        const std::string& data,
                                        ledger::InitializeCallback callback) {
  if (result == ledger::Result::LEDGER_OK) {
...
void LedgerImpl::OnWalletInitialized(int32_t result) {
  initializing_ = false;
