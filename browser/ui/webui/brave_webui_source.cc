  ...
  static std::map<std::string, std::vector<WebUISimpleItem> >
                                                           localized_strings = {
    {
      ...
      std::string("rewards"), {
        ...
        { "contributeTx", IDS_BRAVE_REWARDS_CONTRIBUTE_TX },
        ...
        { "donationTx", IDS_BRAVE_REWARDS_DONATION_TX },
        ...
        { "tokenGrantsReceived", IDS_BRAVE_REWARDS_TOKEN_GRANTS_RECEIVED },
        { "earningsFromAds", IDS_BRAVE_REWARDS_EARNINGS_FROM_ADS },
        { "earningFromAdsTx", IDS_BRAVE_REWARDS_EARNINGS_FROM_ADS_TX },
        { "autoContribute", IDS_BRAVE_REWARDS_AUTO_CONTRIBUTE },
        { "monthlyContribution", IDS_BRAVE_REWARDS_MONTHLY_CONTRIBUTION },
        { "monthlyContributions", IDS_BRAVE_REWARDS_MONTHLY_CONTRIBUTIONS },
        { "monthlyDonation", IDS_BRAVE_REWARDS_MONTHLY_DONATION },
        { "noStatementAutoContributions",
            IDS_BRAVE_REWARDS_NO_STATEMENT_AUTO_CONTRIBUTIONS },
        { "noStatementMonthlyContributions",
            IDS_BRAVE_REWARDS_NO_STATEMENT_MONTHLY_CONTRIBUTIONS },
        { "noStatementTips", IDS_BRAVE_REWARDS_NO_STATEMENT_TIPS },
        { "noStatementTransactions",
            IDS_BRAVE_REWARDS_NO_STATEMENT_TRANSACTIONS },
        { "oneTimeTip", IDS_BRAVE_REWARDS_ONE_TIME_TIP },
        { "oneTimeTips", IDS_BRAVE_REWARDS_ONE_TIME_TIPS },
        { "rewardsContributeVisited", IDS_BRAVE_REWARDS_CONTRIBUTE_VISITED },
        { "rewardsTipVisited", IDS_BRAVE_REWARDS_TIPS_VISITED },
        { "rewardsTipDate", IDS_BRAVE_REWARDS_TIPS_DATE },
        ...
        { "adsStatement", IDS_BRAVE_UI_ADS_EARNINGS_STATEMENT },
        ...
        { "donationAllocation", IDS_BRAVE_UI_DONATION_ALLOCATION },
        { "tipAllocation", IDS_BRAVE_UI_TIP_ALLOCATION },
        ...
        { "grantsStatement", IDS_BRAVE_UI_GRANTS_STATEMENT },
        { "grantsTx", IDS_BRAVE_UI_GRANTS_TX },
        ...
        { "recurringDonationTx", IDS_BRAVE_UI_RECURRING_DONATION_TX },
